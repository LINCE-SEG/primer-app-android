...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valor1=(EditText)findViewById(R.id.editTextPOL1);
        valor2=(EditText)findViewById(R.id.editTextPOL2);
        valor3=(EditText)findViewById(R.id.editTextPOL3);
        respuesta=(TextView)findViewById(R.id.textViewPOL);
    }
